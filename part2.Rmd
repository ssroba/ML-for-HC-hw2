...
- What is (are) the variable name(s) for the outcome?
 ...
 > Death or dependency at 6 months
   OCCODE, which stands for outcome code
...
> Covariates (v): delay between stroke and randomization, conscious state at randomization, sex, age,
...
> Population (w): Patients were eligible if there was evidence of an acute stroke (irrespective of severity) with onset less than 48 hours
